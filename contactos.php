...
<head>
  ...
  <meta charset="utf-8">
  <meta name="description" content="Sitio oficial del PDC. ¡Conéctate con nosotros.!" />
      ...
      <div class="container">
        <div class="row row-40" style="justify-content: center;">
          ...
          <div class="col-md-6 col-lg-4 height-fill">
            <article class="icon-box">
              <div class="box-top">
                <div class="box-icon"><span class="novi-icon icon icon-primary icon-lg fa">&#xf041;</span></div>
                <div class="box-header">
