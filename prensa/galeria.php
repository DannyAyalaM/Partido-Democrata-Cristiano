  ...
  <div class="page">
    ...
    <section style="width:95%;margin: auto;">
      ...
      <div id="row" class="row row-40" style="justify-content: space-evenly;">
        ...
        <div class="col-sm-6 col-md-5 col-lg-3" style="text-align:center" id="carpeta">
          <a href="#ubicar" onclick="mostrar_galeria('alianza')" class="opacidad" style="border:5px solid #255085">
            <figure class="thumbnail-image" id="ubicar">
              <img src="../files/galeria/encuentro-ciudadano/alianza1.webp" alt="album" width="246" height="300" />
            </figure>
            <div class="thumbnail-caption">
              <p class="text-header" style="background-color: #255085;text-align: center;color: white;">Alianza Encuentro Ciudadano</p>
            </div>
          </a>
        </div>
    ...
    <section class="section-35 section-md-50">
      <div id="row1" class="row row-40">
        ...
        <div id="alianza_ec" style="display:none">
          <h4 id="alianza_ec" style="color:white;background:#9f9f9f">Alianza ENCUENTRO CIUDADANO</h4>
          <p>El PDC, PEN, PAC y varios movimientos acompañan la Alianza en Asunción</p><br>
          <div class="grid-gallery">
            <a class="grid-gallery__item fresco" data-fresco-group="alianza_ec" href="../files/galeria/encuentro-ciudadano/alianza1.webp">
              <img class="grid-gallery__image" alt="cumple del presidente" src="../files/galeria/encuentro-ciudadano/alianza1.webp">
            </a>

            <a class="grid-gallery__item fresco" data-fresco-group="alianza_ec" href="../files/galeria/encuentro-ciudadano/alianza2.webp">
              <img class="grid-gallery__image" alt="celebracion" src="../files/galeria/encuentro-ciudadano/alianza2.webp">
            </a>

            <a class="grid-gallery__item fresco" data-fresco-group="alianza_ec" href="../files/galeria/encuentro-ciudadano/alianza3.webp">
              <img class="grid-gallery__image" alt="conversando" src="../files/galeria/encuentro-ciudadano/alianza3.webp">
            </a>

            <a class="grid-gallery__item fresco" data-fresco-group="alianza_ec" href="../files/galeria/encuentro-ciudadano/alianza4.webp">
              <img class="grid-gallery__image" alt="conversando" src="../files/galeria/encuentro-ciudadano/alianza4.webp">
            </a>
